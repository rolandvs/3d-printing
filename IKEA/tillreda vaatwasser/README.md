...
![original](img/ikea_closeup.jpeg)

The parts are described in this page of the manual.

![instruction](img/ikea_instructie.jpeg)

So, this was the sketch used as input for Claude AI. An earlier try shows a version to small and not asymetrical.

![original](img/ikea_schets.png)

After tweaking a bit the end result is verified.

![measure](img/vergelijking.png)

# STL files

[STL left bracket](tillreda_bracket_A.stl)

[STL right bracket](tillreda_bracket_B_gespiegeld.stl)
